...
public class DBConstants {
    ...
    public static final String GET_USER_RECURRENCES = "select count(p.AVAILABLE) from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=?";
}
